...
export const TRUST = {
  ...
  body: "Formulations are developed with ICAR-IARI (Pusa Krishi), ICAR-Central Institute for Fisheries Technology and AgHub (PJTSAU). Studies and trials conducted with these institutes show measurably better outcomes.",
  trialStats: [
