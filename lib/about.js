...
export const HEADLINE_STATS = [
  ...
  { value: "5", label: "Years of R&D", note: "Multi-year feeding trials" },
...
export const PURPOSE = [
  {
    label: "VISION",
    text: "Innovating feed systems to make animal nutrition superior, sustainable and future-ready",
  },
  {
    label: "MISSION",
    text: "Advancing insect protein technology to develop and commercialise scientifically validated formulations which will make animal nutrition sustainable and future ready",
  },
];
...
export const TRUST = {
  ...
  institutionLogos: [
    ...
    { src: "/logos/Ksidc.png", alt: "KSIDC — Kerala State Industrial Development Corporation" },
  ],
  /** Named backers with no logo file supplied. */
  institutionsTextOnly: [],
  recognition: [
    "Adani Vandhe Bharatham 2026 Finalist",
    "Temasek - Ecosphere NextGen leaders cohort, Singapore 2025",
    "ICAR-IARI UPJA recipient 2024",
    "Australian Foreign Ministry - AAGS 2023 winner",
    "EY - Climathon 2022 Winner",
    "Government of India - Swacch Technology Challenge, Kerala Finalist",
    "United Nations Development Programme - GIF 2021 winner",
    "NABARD Catalytic Capital Fund",
...
export const RANGE = {
  ...
  products: [
    ...
    { name: "Hatch'E", spec: "H1/H2/H3 - growth stage based grading to ensure right feed sizing", slug: "hatchery-feeds" },
