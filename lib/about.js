...
export const HEADLINE_STATS = [
  ...
  { value: "12+", label: "Formulations", note: "Species-specific" },
];
...
export const RANGE = {
  ...
  body: "Over 12 distinct formulations, each developed for a specific species or group — protein from 26% to 50%, pellets from 0.175 mm powder to 4 mm floating koi.",
  products: [
...
export const REGISTERED_ADDRESS =
  "Zewa Ecosystems Pvt Ltd, 17/31A TR Nair Road, Kuttanellur PO, Thrissur, Kerala, IN 680014.";
