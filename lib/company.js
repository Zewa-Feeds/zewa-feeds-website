...
export const COMPANY = {
  ...
  /*
   * Customer care line. NOT the number on the GST certificate — that is the
   * registered contact and reaches the founder directly.
   */
  ...
  grievanceOfficer: {
    ...
    /*
     * Routed to the general inbox for now — grievance@ is not provisioned, and
     * publishing an address that bounces is worse than publishing a shared one.
     */
    email: "info@zewafeeds.com",
