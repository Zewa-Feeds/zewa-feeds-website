export const ARTICLES = [
  ...
  },
  {
    ...
    imageAlt:
      "Planted freshwater aquarium with clear water, illustrating the tank conditions supported by high-digestibility feed",
    stat: "1.38",
    statLabel: "feed conversion ratio",
    seo: {
      title: "Reducing Ammonia in Aquariums Through High-Digestibility Fish Food",
      description:
        "Ammonia in ornamental tanks is largely a nutrition problem. How protein digestibility and feed conversion ratio determine nitrogen waste, and what the numbers actually show.",
      focusKeyword: "reduce ammonia in aquarium",
      keywords: [
        "reduce ammonia in aquarium",
        "fish food ammonia",
        "feed conversion ratio ornamental fish",
        "protein digestibility fish feed",
        "insect protein aquafeed",
      ],
      ogTitle: "Reducing Ammonia Output Through High-Absorption Diets",
      ogDescription:
        "Fish excrete ammonia through their gills, in proportion to protein they cannot use. Better-absorbed protein means less of it.",
    },
    featured: false,
    author: "Zewa Research Team",
    date: "14 May 2026",
    isoDate: "2026-05-14",
    toc: [
      { id: "where-ammonia-comes-from", label: "Where ammonia comes from" },
      { id: "high-bioavailability-protein", label: "The solution: high bioavailability protein" },
      { id: "what-fcr-measures", label: "What feed conversion ratio measures" },
    ],
    content: [
      {
        type: "lead",
        text: "Ammonia toxicity is one of the most common silent killers in ornamental tanks. It accumulates invisibly, stresses fish before any visible symptoms appear, and forces hobbyists into reactive water-change schedules. The root cause is almost always nutritional.",
      },
      {
        type: "h2",
        id: "where-ammonia-comes-from",
      ...
      {
        type: "p",
        text: "A diet with 88% pepsin digestibility means the body absorbs and uses the vast majority of ingested protein for tissue synthesis rather than excreting it as waste. Less catabolism means less ammonia.",
      },
      {
        type: "stat-block",
        items: [
          { val: "88%", label: "Pepsin digestibility of Zewa insect protein formulas" },
          { val: "1.38", label: "Feed conversion ratio in ICAR-supported controlled trials" },
        ],
      },
      {
        type: "h2",
        id: "high-bioavailability-protein",
        text: "The solution: high bioavailability protein.",
      },
      {
        type: "p",
        text: "Insect-based protein — particularly from Black Soldier Fly larvae — has an amino acid profile closely matched to the nutritional requirements of tropical ornamentals. This close match means the body utilises a higher percentage of ingested protein for tissue synthesis rather than energy production. Less catabolism means less ammonia.",
      },
      {
        type: "h2",
        id: "what-fcr-measures",
        text: "What feed conversion ratio measures.",
      },
      {
        type: "p",
        text: "The clearest measure of this is feed conversion ratio (FCR) — how many grams of feed a fish needs to gain one gram of body weight. In ICAR-supported controlled feeding trials, Zewa insect-protein formulas recorded an FCR of 1.38, compared to 1.80 and 4.07 for conventional shrimp-meal and fish-meal based feeds. A lower FCR means more nutrition absorbed per feeding, less waste in the water column, and a measurably lower ammonia load on the tank's biological filtration.",
      },
      {
        type: "table",
        caption: "Feed conversion ratio by feed type — ICAR-supported controlled feeding trials",
        headers: ["Feed type", "FCR", "Interpretation"],
        rows: [
          ["Zewa insect protein", "1.38", "1.38 g of feed per 1 g of growth"],
          ["Shrimp-meal based", "1.80", "30% more feed for the same growth"],
          ["Fish-meal based", "4.07", "Nearly 3× the feed for the same growth"],
        ],
      },
      {
        type: "pullquote",
        text: "Better feed does not just grow healthier fish. It builds a healthier tank.",
      },
    ],
  },
  {
