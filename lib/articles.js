export const ARTICLES = [
  {
    slug: "crude-protein-fish-food-vs-protein-quality",
    tag: "FEED SCIENCE",
    tagColor: "#a78bfa",
    tagBg: "rgba(167,139,250,0.10)",
    readTime: "8 min",
    title: "Crude protein vs protein quality: what the fish food label shows.",
    shortTitle: "Crude Protein vs Protein Quality",
    excerpt:
      "Two ornamental fish feeds can both declare 40% crude protein and produce different rates of growth in the same species. What the figure measures, what it omits, and what to read alongside it.",
    image: "/crude-protein-hero.jpg",
    imageAlt:
      "Crude protein percentage on a Zewa Feeds fish food nutritional analysis label",
    stat: "6.25",
    statLabel: "nitrogen conversion factor",
    seo: {
      title: "Crude Protein in Fish Food: What the Label Misses",
      description:
        "Crude protein in fish food measures nitrogen, not quality. Learn what the label omits: amino acid balance, limiting amino acids and digestibility.",
      focusKeyword: "crude protein fish food",
      keywords: [
        "protein quality fish feed",
        "essential amino acids fish",
        "limiting amino acid",
        "lysine methionine fish feed",
        "fish food label",
      ...
      ogTitle: "Crude Protein vs Protein Quality in Fish Feed: What the Label Shows",
      ogDescription:
        "Crude protein reports nitrogen content, not amino acid balance or digestibility. What the declared percentage cannot tell you.",
    },
    featured: false,
    ...
    isoDate: "2026-09-16",
    toc: [
      { id: "what-it-measures", label: "What crude protein measures" },
      { id: "amino-acid-requirement", label: "An amino acid requirement" },
      { id: "limiting-amino-acid", label: "The limiting amino acid" },
      { id: "not-comparable", label: "Why it is not comparable" },
      { id: "at-a-glance", label: "At a glance" },
      { id: "what-to-read", label: "What to read alongside it" },
    ...
    content: [
      {
        type: "lead",
        text: "Two ornamental fish feeds can both declare 40% crude protein and produce different rates of growth in the same species. The declared figure is identical; the nutritional outcome is not.",
      },
      {
        type: "p",
        text: "Crude protein is the value most aquarists compare when choosing a feed. It measures the nitrogen content of a feed. It does not describe what that protein is composed of, or how much of it the fish can absorb. This post covers what the figure measures, what it omits, and which values are worth reading alongside it. It follows our comparison of fish meal, soy and insect protein as raw ingredients, and examines how those differences appear, or fail to appear, on the label.",
        links: [
          {
            text: "our comparison of fish meal, soy and insect protein",
            href: "/blog/fish-meal-vs-soy-vs-insect-protein",
          },
        ],
      },

      { type: "h2", id: "what-it-measures", text: "What crude protein on a fish food label actually measures" },
      {
        type: "p",
        text: "Crude protein is not measured directly. Laboratories measure total nitrogen in a sample, usually by the Kjeldahl or Dumas method, then multiply that figure by a conversion factor to arrive at a protein percentage. The standard factor is 6.25, based on the assumption that protein is approximately 16% nitrogen by weight [3].",
      },
      {
        type: "p",
        text: "That assumption is a generalisation, and it carries two consequences.",
      },
      {
        type: "takeaways",
        title: "Two consequences of the conversion factor",
        items: [
          "The factor is not equally accurate for every ingredient. Nitrogen content varies with amino acid composition, so food-specific conversion factors exist for different materials [3].",
          "Nitrogen analysis cannot separate protein nitrogen from other nitrogen. Nucleic acids, free amino acids and other nitrogenous compounds all register in the result [3].",
        ],
      },
      {
        type: "p",
        text: "The term “crude” is therefore accurate. The figure is an estimate derived from elemental nitrogen, not a direct measurement of protein.",
      },

      { type: "h2", id: "amino-acid-requirement", text: "Fish do not have a protein requirement, they have an amino acid requirement" },
      {
        type: "figure",
        src: "/crude-protein-amino-acids.jpg",
        alt: "Diagram showing dietary protein digested into amino acids for absorption in fish",
        caption: "Dietary protein is broken down into amino acids before absorption — the amino acids, not the protein, are what the fish actually requires.",
      },
      {
        type: "p",
        text: "Protein is digested into amino acids before it is absorbed. What the fish requires is a supply of specific amino acids in the correct proportions. Ten of these are considered essential for fish, meaning they cannot be synthesised at a rate that meets demand and must come from the diet: methionine, arginine, threonine, tryptophan, histidine, isoleucine, lysine, leucine, valine and phenylalanine [1].",
      },
      {
        type: "p",
        text: "A feed can be high in nitrogen and still be a poor amino acid match for the species consuming it. The crude protein figure is unchanged in either case, because nitrogen analysis does not resolve amino acid balance.",
      },

      { type: "h2", id: "limiting-amino-acid", text: "The limiting amino acid sets the ceiling" },
      {
        type: "figure",
        src: "/crude-protein-limiting-amino-acid.jpg",
        alt: "Limiting amino acid concept showing lysine restricting protein synthesis in fish",
        caption: "Protein synthesis runs only as far as the amino acid in shortest supply allows — the rest is deaminated and excreted.",
      },
      {
        type: "p",
        text: "Protein synthesis proceeds only as far as the amino acid in shortest supply allows. Once that amino acid is depleted, synthesis stops regardless of the quantity of the others remaining. That amino acid is termed the limiting amino acid, and the surplus of the remainder is deaminated and excreted rather than incorporated into tissue [2,4].",
      },
      {
        type: "p",
        text: "Lysine and methionine are the two most commonly limiting amino acids in fish feed. Plant proteins such as soybean meal are typically low in methionine [1], and lysine is generally the first limiting amino acid in plant-protein-based aquafeeds, which is why it is used as the reference point in ideal protein formulation [2].",
      },
      {
        type: "pullquote",
        text: "Correcting the amino acid balance can allow a feed with lower crude protein to outperform one with higher crude protein, while producing less nitrogenous waste.",
      },
      {
        type: "p",
        text: "This has a practical consequence. Correcting the amino acid balance can allow a feed with lower crude protein to outperform one with higher crude protein, while producing less nitrogenous waste, because less surplus protein is deaminated and excreted [2].",
      },

      { type: "h2", id: "not-comparable", text: "Why crude protein is not comparable across ingredient types" },
      {
        type: "p",
        text: "The declared percentage says nothing about the source behind it. Protein from different raw materials differs in amino acid profile and in the proportion a fish can digest and absorb, and meeting a species requirement depends on digestible amino acids rather than total ones, because no animal utilises everything it consumes [2].",
      },
      {
        type: "p",
        text: "A feed built on a highly digestible protein with a complete amino acid profile therefore delivers more usable protein per declared percentage point than one built on a source that is poorly matched or poorly absorbed. Two feeds declaring 40% are equivalent only if the protein behind the number is equivalent, and the label does not indicate whether it is.",
      },

      { type: "h2", id: "at-a-glance", text: "Crude protein and protein quality at a glance" },
      {
        type: "table",
        caption: "What each value measures, how it is determined, and what it cannot show.",
        headers: ["", "Crude protein (%)", "Protein quality"],
        highlightColumn: 2,
        rows: [
      ...
      { type: "h2", id: "what-to-read", text: "What to read alongside the crude protein figure" },
      {
        type: "p",
        text: "Crude protein remains a necessary declaration, and a 46% feed and a 28% feed are formulated for different animals. It is one input rather than a complete answer. Three further values are worth checking.",
      },

      { type: "h3", text: "The ingredient list, in order" },
      {
        type: "p",
        text: "Ingredients are declared in descending order by weight. The first three positions indicate where the protein originates, which in turn indicates the likely amino acid profile behind the figure.",
      },

      { type: "h3", text: "Species suitability" },
      {
        type: "p",
        text: "A 46% protein feed is appropriate for a carnivorous betta and unsuitable for a goldfish, which lacks a true stomach. A higher figure is not inherently better; a matched figure is.",
        links: [{ text: "A 46% protein feed", href: "/products" }],
      },

      { type: "h3", text: "Digestibility, where published" },
      {
        type: "p",
        text: "Only absorbed protein contributes to growth. Digestibility testing measures the fraction a fish can break down and take up, which is the gap crude protein cannot close. Few ornamental feed brands publish a digestibility figure. Zewa feeds are tested through an NABL accredited laboratory, and the insect protein base has been assessed at 88% pepsin digestibility.",
      },
      ...
      { type: "h2", id: "faq", text: "Frequently asked questions" },
      {
        ...
        items: [
          {
            q: "Is higher crude protein always better in fish food?",
            a: "No. The appropriate level depends on the species, its digestive anatomy and its life stage. Protein supplied beyond what the fish can use is deaminated and excreted as ammonia, increasing the waste load without a corresponding benefit [2].",
          },
          {
            q: "Why do two feeds with the same crude protein perform differently?",
            a: "Crude protein does not describe amino acid balance or digestibility. If one feed is deficient in a limiting amino acid such as lysine or methionine, growth is constrained at that point irrespective of the declared figure.",
          },
          {
            q: "What does “crude” mean in crude protein?",
            a: "It signals that the value is an estimate calculated from total nitrogen rather than a direct measurement of protein. Any non-protein nitrogen present in the sample is included in the result [3].",
          },
        ],
      },

      { type: "h2", id: "takeaway", text: "The takeaway" },
      {
        type: "p",
        text: "Crude protein reports the nitrogen content of a feed. It does not identify which amino acids that nitrogen represents, whether the profile matches the species, or what proportion is absorbed rather than excreted. Those three factors determine growth, colouration and waste load, and none of them appear on the label.",
      },
      ...
      { type: "h2", id: "references", text: "References" },
      {
        ...
        items: [
          {
            n: 1,
            text: "Craig, S., Helfrich, L.A., Kuhn, D.D. & Schwarz, M.H. Understanding Fish Nutrition, Feeds, and Feeding. Virginia Cooperative Extension, Publication 420-256 (FST-269P).",
            href: "https://hdl.handle.net/10919/48950",
          },
          {
            n: 2,
            text: "Miles, R.D. & Chapman, F.A. The Concept of Ideal Protein in Formulation of Aquaculture Feeds. UF/IFAS Extension, FA144.",
            href: "https://ask.ifas.ufl.edu/publication/FA144",
          },
          {
            n: 3,
            text: "Mæhre, H.K., Dalheim, L., Edvinsen, G.K., Elvevoll, E.O. & Jensen, I.-J. (2018). Protein Determination—Method Matters. Foods, 7(1):5.",
            href: "https://doi.org/10.3390/foods7010005",
          },
          {
            n: 4,
            text: "Tacon, A.G.J. The Nutrition and Feeding of Farmed Fish and Shrimp: A Training Manual — The Essential Nutrients. FAO.",
            href: "https://www.fao.org/4/ab470e/ab470e02.htm",
          },
        ],
      },
    ],
...

  {
    ...
    image: "/astaxanthin-natural-carotenoids-banner.jpg",
    imageAlt:
      "Astaxanthin natural carotenoids molecule structure and 2x pigment bioavailability banner",
    stat: "2×",
