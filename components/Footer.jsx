      ...
      <div className="max-w-[1440px] mx-auto px-8 pt-12 pb-10">
        <div className="grid grid-cols-1 md:grid-cols-[280px_1fr_1fr_1fr] gap-12 md:gap-8">
          ...
          <div className="flex flex-col gap-4">
            ...
            {/* Social icons */}
            <div>
              <p className="font-label-caps text-[10px] text-on-surface/30 tracking-[0.15em] mb-3">FOLLOW US</p>
              <div className="flex items-center gap-2 flex-wrap">
                {socialLinks.map((s) => (
                  <a
                    ...
                    aria-label={s.label}
                    className={`w-8 h-8 rounded-full bg-white/5 border border-white/8 flex items-center justify-center text-on-surface/40 ${s.color} hover:bg-white/10 hover:border-white/20 transition-all duration-200`}
                  >
                    {s.icon}
                  </a>
                ))}
