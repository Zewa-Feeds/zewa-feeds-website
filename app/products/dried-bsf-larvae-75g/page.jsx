...
const PACKS = [
  { size: "75g", price: "₹449", mrp: "₹560", sku: "DBSFL-75G", badge: null },
];

const GALLERY = [
  { type: "image", label: "Front", src: "/Bottles/DBSFL/DBSFL 75G.png" },
  { type: "video", label: "Watch", src: "/videos/brand_video.mp4", poster: "/Bottles/DBSFL/DBSFL 75G.png" },
  { type: "image", label: "Front Detail", src: "/Bottles/DBSFL/DBSFL 75G_Front.png" },
  { type: "image", label: "Back", src: "/Bottles/DBSFL/DBSFL 75G_back.png" },
  { type: "image", label: "Info", src: "/Bottles/DBSFL/India/75/Artboard 1.png" },
];

const HIGHLIGHTS = [
  { title: "50% Insect Protein", sub: "Same formula as 25g, larger volume" },
  { title: "3× Volume", sub: "75g vs 25g — better value per gram" },
  { title: "Hatchery Operators", sub: "Sized for professional daily feeding schedules" },
  { title: "92% Digestibility", sub: "Minimal ammonia output at scale" },
  { title: "Whole Dried Larvae", sub: "Unprocessed — maximum nutrient retention" },
  { title: "Zero Fillers", sub: "No soy, no synthetic binders" },
];

const FEATURES = [
  { title: "50% Insect Protein at Scale", desc: "The 75g pack delivers the same 50% protein formula as the 25g, optimised for facilities that feed multiple tanks daily." },
  { title: "Cost Efficiency for Breeders", desc: "At ₹449 vs ₹199 for 25g, the 75g pack reduces per-gram cost by 19% — significant savings across a breeding operation." },
  { title: "Resealable Packaging", desc: "Designed for repeated opening and closing without nutrient degradation from moisture exposure." },
  { title: "Whole Larvae Integrity", desc: "Larvae are dried whole at controlled temperature to preserve fat content, chitin, and heat-labile vitamins." },
  { title: "92% Digestibility", desc: "At hatchery density, clean protein metabolism is essential — near-complete absorption means cleaner water across all tanks." },
  { title: "Natural Chitin Prebiotic", desc: "Regular chitin intake through whole larvae supports gut microbiome health and immune resilience in juvenile fish." },
];
...
const SUITABLE = [
  { name: "Hatchery Operations", desc: "High-volume feeding across multiple tanks" },
  { name: "Breeding Pairs", desc: "Conditioning adults for spawning with maximum protein" },
  { name: "Fry Nurseries", desc: "Dense protein for rapid early-stage development" },
  { name: "Arowana & Predators", desc: "Large carnivorous species requiring whole prey" },
  { name: "Discus Colonies", desc: "Multiple fish requiring consistent premium nutrition" },
  { name: "Serious Hobbyists", desc: "Anyone feeding multiple tanks or species daily" },
];

const RELATED = [
  { name: "Dried BSF Larvae 25g", tagline: "Starter pack — same formula", href: "/products/dried-bsf-larvae-25g", image: "/Bottles/DBSFL/DBSFL 25G.png" },
      ...
      <main className="bg-[#080e1c] text-[#dde2f6] min-h-screen">
        ...
        <div className="max-w-[1440px] mx-auto px-6 sm:px-10 lg:px-16 pt-28 pb-4">
          <nav className="flex items-center gap-2 text-[12px] text-white/30 font-[Montserrat]">
            ...
            <span>/</span>
            <span className="text-white/60">Dried BSF Larvae 75g</span>
          </nav>
        </div>
            ...
            <div className="flex flex-col gap-6 lg:pt-2">
              ...
              <div>
                <h1 className="font-[Playfair_Display] text-[36px] sm:text-[44px] leading-[1.1] text-white mb-3">
                  Dried BSF Larvae 75g
                </h1>
                <p className="text-[15px] text-white/55 leading-relaxed font-[Montserrat] max-w-md">
                  Professional-volume whole dried larvae for hatchery operators and serious breeders. 50% protein. Zero fillers.
                </p>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-[12px] text-white/35 font-[Montserrat] ml-1">4.9 · 147 reviews</span>
              </div>
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <button onClick={handleAddToCart}
                    className={`flex-1 py-4 px-6 font-bold text-[13px] tracking-widest uppercase font-[Montserrat] active:scale-[0.98] transition-all rounded-sm flex items-center justify-center gap-2 ${added ? "bg-emerald-500 text-white" : ""}`}
        ...
        <div className="max-w-[1440px] mx-auto px-6 sm:px-10 lg:px-16 py-16">
          ...
          {activeTab === "Ingredients" && (
            <div className="max-w-3xl">
              <p className="text-[13px] text-white/50 font-[Montserrat] mb-8">Single ingredient product — whole dried Black Soldier Fly Larvae (<em>Hermetia illucens</em>). No additives, no fillers.</p>
