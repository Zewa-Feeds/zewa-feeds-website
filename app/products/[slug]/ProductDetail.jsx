      ...
      <main className={`bg-[#06080f] min-h-screen text-[#dde2f6] pb-20 ${readOnly ? "pt-36" : "pt-28"}`}>
        <div className="max-w-[1180px] mx-auto px-6 sm:px-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            <div className="flex flex-col gap-6 bg-[#09121f] p-6 sm:p-8 rounded-3xl border border-[#44e5c2]/35 shadow-[0_0_22px_rgba(68,229,194,0.16)] transition-all duration-300 text-white">
              <div
                className="group relative aspect-square overflow-hidden rounded-2xl flex items-center justify-center border border-[#44e5c2]/35 shadow-[0_0_16px_rgba(68,229,194,0.12)] bg-[#070e19]"
              >
          ...
          <div className="mt-20">
            ...
            <div className="py-8">
              {tab === "description" && (
                <div
                  className="prose-zewa w-full max-w-none text-[14px] leading-relaxed text-white/70 font-[Montserrat]"
